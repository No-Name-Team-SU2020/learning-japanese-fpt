...
export const GLOBAL_GET_SINGLE_QUESTION_SUCCESS =
  "GLOBAL_GET_SINGLE_QUESTION_SUCCESS";
export const GLOBAL_GET_SINGLE_QUESTION_START =
  "GLOBAL_GET_SINGLE_QUESTION_START";
export const GLOBAL_GET_SINGLE_QUESTION_FAILED =
...
export const TEACHER_GET_CLASSES_BY_SUBJECT_START =
  "TEACHER_GET_CLASSES_BY_SUBJECT_START";
export const TEACHER_GET_CLASSES_BY_SUBJECT_SUCCESS =
  "TEACHER_GET_CLASSES_BY_SUBJECT_SUCCESS";
export const TEACHER_GET_CLASSES_BY_SUBJECT_FAILED =
...
export const TEACHER_GET_MY_SUBJECTS_SUCCESS =
  "TEACHER_GET_MY_SUBJECTS_SUCCESS";
export const TEACHER_GET_MY_SUBJECTS_FAILED = "TEACHER_GET_MY_SUBJECTS_FAILED";

export const TEACHER_GET_SUBJECTS_BY_CLASS = "TEACHER_GET_SUBJECTS_BY_CLASS";
export const TEACHER_GET_SUBJECTS_BY_CLASS_START =
  "TEACHER_GET_SUBJECTS_BY_CLASS_START";
export const TEACHER_GET_SUBJECTS_BY_CLASS_SUCCESS =
  "TEACHER_GET_SUBJECTS_BY_CLASS_SUCCESS";
export const TEACHER_GET_SUBJECTS_BY_CLASS_FAILED =
  "TEACHER_GET_SUBJECTS_BY_CLASS_FAILED";

export const TEACHER_GET_STUDENTS_BY_CLASS = "TEACHER_GET_STUDENTS_BY_CLASS";
export const TEACHER_GET_STUDENTS_BY_CLASS_START =
  "TEACHER_GET_STUDENTS_BY_CLASS_START";
export const TEACHER_GET_STUDENTS_BY_CLASS_SUCCESS =
  "TEACHER_GET_STUDENTS_BY_CLASS_SUCCESS";
export const TEACHER_GET_STUDENTS_BY_CLASS_FAILED =
...
export const ADMIN_GET_SINGLE_LESSON_SUCCESS =
...
export const STUDENT_GET_ATTENDANCE_SUCCESS = "STUDENT_GET_ATTENDANCE_SUCCESS";
export const STUDENT_GET_ATTENDANCE_START = "STUDENT_GET_ATTENDANCE_START";
export const STUDENT_GET_ATTENDANCE_FAILED = "STUDENT_GET_ATTENDANCE_FAILED";

export const STUDENT_GET_RESULTS = "STUDENT_GET_RESULTS";
export const STUDENT_GET_RESULTS_SUCCESS = "STUDENT_GET_RESULTS_SUCCESS";
export const STUDENT_GET_RESULTS_START = "STUDENT_GET_RESULTS_START";
export const STUDENT_GET_RESULTS_FAILED = "STUDENT_GET_RESULTS_FAILED";

// quiz types

export const ADMIN_GET_ALL_QUIZ_PRESET = 'ADMIN_GET_ALL_QUIZ_PRESET';
export const ADMIN_GET_ALL_QUIZ_PRESET_START = 'ADMIN_GET_ALL_QUIZ_PRESET_START';
export const ADMIN_GET_ALL_QUIZ_PRESET_SUCCESS = 'ADMIN_GET_ALL_QUIZ_PRESET_SUCCESS';
export const ADMIN_GET_ALL_QUIZ_PRESET_FAILED = 'ADMIN_GET_ALL_QUIZ_PRESET_FAILED';

export const ADMIN_UPDATE_QUIZ_PRESET = 'ADMIN_UPDATE_QUIZ_PRESET';
export const ADMIN_UPDATE_QUIZ_PRESET_START = 'ADMIN_UPDATE_QUIZ_PRESET_START';
export const ADMIN_UPDATE_QUIZ_PRESET_SUCCESS = 'ADMIN_UPDATE_QUIZ_PRESET_SUCCESS';
export const ADMIN_UPDATE_QUIZ_PRESET_FAILED = 'ADMIN_UPDATE_QUIZ_PRESET_FAILED';

export const ADMIN_CREATE_QUIZ_PRESET = 'ADMIN_CREATE_QUIZ_PRESET';
export const ADMIN_CREATE_QUIZ_PRESET_START = 'ADMIN_CREATE_QUIZ_PRESET_START';
export const ADMIN_CREATE_QUIZ_PRESET_SUCCESS = 'ADMIN_CREATE_QUIZ_PRESET_SUCCESS';
export const ADMIN_CREATE_QUIZ_PRESET_FAILED = 'ADMIN_CREATE_QUIZ_PRESET_FAILED';

export const ADMIN_DELETE_QUIZ_PRESET = 'ADMIN_DELETE_QUIZ_PRESET';
export const ADMIN_DELETE_QUIZ_PRESET_START = 'ADMIN_DELETE_QUIZ_PRESET_START';
export const ADMIN_DELETE_QUIZ_PRESET_SUCCESS = 'ADMIN_DELETE_QUIZ_PRESET_SUCCESS';
export const ADMIN_DELETE_QUIZ_PRESET_FAILED = 'ADMIN_DELETE_QUIZ_PRESET_FAILED';

export const ADMIN_UPDATE_QUIZ_PRESET_STATUS = 'ADMIN_UPDATE_QUIZ_PRESET_STATUS';
export const ADMIN_UPDATE_QUIZ_PRESET_STATUS_START = 'ADMIN_UPDATE_QUIZ_PRESET_STATUS_START';
export const ADMIN_UPDATE_QUIZ_PRESET_STATUS_SUCCESS = 'ADMIN_UPDATE_QUIZ_PRESET_STATUS_SUCCESS';
export const ADMIN_UPDATE_QUIZ_PRESET_STATUS_FAILED = 'ADMIN_UPDATE_QUIZ_PRESET_STATUS_FAILED';

export const GLOBAL_GET_LIST_GRAMMAR = 'GLOBAL_GET_LIST_GRAMMAR';
export const GLOBAL_GET_LIST_GRAMMAR_START = 'GLOBAL_GET_LIST_GRAMMAR_START';
export const GLOBAL_GET_LIST_GRAMMAR_SUCCESS = 'GLOBAL_GET_LIST_GRAMMAR_SUCCESS';
export const GLOBAL_GET_LIST_GRAMMAR_FAILED = 'GLOBAL_GET_LIST_GRAMMAR_FAILED';

export const GLOBAL_GET_SINGLE_GRAMMAR = 'GLOBAL_GET_SINGLE_GRAMMAR';
export const GLOBAL_GET_SINGLE_GRAMMAR_START = 'GLOBAL_GET_SINGLE_GRAMMAR_START';
export const GLOBAL_GET_SINGLE_GRAMMAR_SUCCESS = 'GLOBAL_GET_SINGLE_GRAMMAR_SUCCESS';
export const GLOBAL_GET_SINGLE_GRAMMAR_FAILED = 'GLOBAL_GET_SINGLE_GRAMMAR_FAILED';

export const ADMIN_DELETE_GRAMMAR = 'ADMIN_DELETE_GRAMMAR';
export const ADMIN_DELETE_GRAMMAR_START = 'ADMIN_DELETE_GRAMMAR_START';
export const ADMIN_DELETE_GRAMMAR_SUCCESS = 'ADMIN_DELETE_GRAMMAR_SUCCESS';
export const ADMIN_DELETE_GRAMMAR_FAILED = 'ADMIN_DELETE_GRAMMAR_FAILED';

export const ADMIN_CREATE_GRAMMAR = 'ADMIN_CREATE_GRAMMAR';
export const ADMIN_CREATE_GRAMMAR_START = 'ADMIN_CREATE_GRAMMAR_START';
export const ADMIN_CREATE_GRAMMAR_SUCCESS = 'ADMIN_CREATE_GRAMMAR_SUCCESS';
export const ADMIN_CREATE_GRAMMAR_FAILED = 'ADMIN_CREATE_GRAMMAR_FAILED';

export const ADMIN_UPDATE_GRAMMAR = 'ADMIN_UPDATE_GRAMMAR';
export const ADMIN_UPDATE_GRAMMAR_START = 'ADMIN_UPDATE_GRAMMAR_START';
export const ADMIN_UPDATE_GRAMMAR_SUCCESS = 'ADMIN_UPDATE_GRAMMAR_SUCCESS';
export const ADMIN_UPDATE_GRAMMAR_FAILED = 'ADMIN_UPDATE_GRAMMAR_FAILED';